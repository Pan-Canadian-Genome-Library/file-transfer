...
public class JWTSecurityTest {
  ...
  private static final String NON_EXISTING_PROJECT_CODE = "FAKE";

  private static final String EXISTING_PROJECT_CODE = "TEST";
  private static final String EXISTING_OBJECT_ID = "123";
  private static final String EXISTING_GNOS_ID = "123";

  private static final String DOWNLOAD_ENDPOINT =
      "/download/" + EXISTING_OBJECT_ID + "?offset=0&length=-1";
  private static final String UPLOAD_ENDPOINT =
      "/upload/" + EXISTING_OBJECT_ID + "/uploads?fileSize=1";

  private static final boolean EXPIRED = true;
  private static final boolean NOT_EXPIRED = !EXPIRED;
  ...
  @Test
  public void jwtDownloadValidation_validStudyScope_Success() {
    executeAndAssert(DOWNLOAD, VALID_STUDY, NOT_EXPIRED, OK);
  }

  @Test
  public void jwtDownloadValidation_validSystemScope_Success() {
    executeAndAssert(DOWNLOAD, VALID_SYSTEM, NOT_EXPIRED, OK);
  }

  @Test
  public void jwtDownloadValidation_validStudyScopeExpired_Unauthorized() {
    executeAndAssert(DOWNLOAD, VALID_STUDY, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtDownloadValidation_validSystemScopeExpired_Unauthorized() {
    executeAndAssert(DOWNLOAD, VALID_SYSTEM, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtDownloadValidation_missingScopeField_Forbidden() {
    executeAndAssert(DOWNLOAD, EMPTY_SCOPE, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtDownloadValidation_missingScopeFieldExpired_Unauthorized() {
    executeAndAssert(DOWNLOAD, EMPTY_SCOPE, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtDownloadValidation_invalidSystemScope_Forbidden() {
    executeAndAssert(DOWNLOAD, INVALID_SYSTEM, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtDownloadValidation_invalidStudyScope_Forbidden() {
    executeAndAssert(DOWNLOAD, INVALID_STUDY, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtDownloadValidation_invalidSystemScopeExpired_Unauthorized() {
    executeAndAssert(DOWNLOAD, INVALID_SYSTEM, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtDownloadValidation_invalidStudyScopeExpired_Unauthorized() {
    executeAndAssert(DOWNLOAD, INVALID_STUDY, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtDownloadValidation_malformedAccessToken_Unauthorized() {
    executeAndAssert(DOWNLOAD, MALFORMED, NOT_EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_validStudyScope_Success() {
    executeAndAssert(UPLOAD, VALID_STUDY, NOT_EXPIRED, OK);
  }

  @Test
  public void jwtUploadValidation_validSystemScope_Success() {
    executeAndAssert(UPLOAD, VALID_SYSTEM, NOT_EXPIRED, OK);
  }

  @Test
  public void jwtUploadValidation_validStudyScopeExpired_Unauthorized() {
    executeAndAssert(UPLOAD, VALID_STUDY, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_validSystemScopeExpired_Unauthorized() {
    executeAndAssert(UPLOAD, VALID_SYSTEM, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_missingScopeField_Forbidden() {
    executeAndAssert(UPLOAD, EMPTY_SCOPE, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtUploadValidation_missingScopeFieldExpired_Unauthorized() {
    executeAndAssert(UPLOAD, EMPTY_SCOPE, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_invalidSystemScope_Forbidden() {
    executeAndAssert(UPLOAD, INVALID_SYSTEM, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtUploadValidation_invalidStudyScope_Forbidden() {
    executeAndAssert(UPLOAD, INVALID_STUDY, NOT_EXPIRED, FORBIDDEN);
  }

  @Test
  public void jwtUploadValidation_invalidSystemScopeExpired_Unauthorized() {
    executeAndAssert(UPLOAD, INVALID_SYSTEM, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_invalidStudyScopeExpired_Unauthorized() {
    executeAndAssert(UPLOAD, INVALID_STUDY, EXPIRED, UNAUTHORIZED);
  }

  @Test
  public void jwtUploadValidation_malformedAccessToken_Unauthorized() {
  ...
  private ResponseEntity<String> executeRequest(
      HttpMethod httpMethod, String url, HttpHeaders headers) {
  ...
  private String generateConstrainedJWTString(
    ...
    if (scopeOptions == ScopeOptions.MALFORMED) {
      return "";
    }
  ...
  private void setMocks() {
    ...
    when(downloadService.download(
            eq(EXISTING_OBJECT_ID), anyLong(), anyLong(), anyBoolean(), anyBoolean()))
        .thenReturn(dummyObject);

    val newObjectSpec = ObjectSpecification.builder().objectId(EXISTING_OBJECT_ID).build();
    when(uploadService.initiateUpload(eq(EXISTING_OBJECT_ID), anyByte(), anyString(), anyBoolean()))
        .thenReturn(newObjectSpec);
  }
